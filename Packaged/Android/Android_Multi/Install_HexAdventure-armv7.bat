...
%ADB% %DEVICE% install HexAdventure-armv7.apk
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.TwoBricksGamingCompany.HexAdventure
@echo.
@echo Installing new data. Failures here indicate storage problems (missing SD card or bad permissions) and are fatal.
%ADB% %DEVICE% push main.1.com.TwoBricksGamingCompany.HexAdventure.obb %STORAGE%/obb/com.TwoBricksGamingCompany.HexAdventure/main.1.com.TwoBricksGamingCompany.HexAdventure.obb
if "%ERRORLEVEL%" NEQ "0" goto Error
...
%ADB% %DEVICE% shell pm grant com.TwoBricksGamingCompany.HexAdventure android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant com.TwoBricksGamingCompany.HexAdventure android.permission.WRITE_EXTERNAL_STORAGE
